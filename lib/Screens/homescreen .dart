    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
               ...
               RecentLocation(Type: "Office", Location: "Gopalpura Bypass, Shankar Nagar, Mansarovar", Distance: "2.6 Km"),
                            RecentLocation(Type: "Office", Location: "Gopalpura Bypass, Shankar Nagar, Mansarovar", Distance: "2.6 Km"),
                                         RecentLocation(Type: "Office", Location: "Gopalpura Bypass, Shankar Nagar, Mansarovar", Distance: "2.6 Km"),
          ...
          context,
          MaterialPageRoute(
            builder: (context) => SelectVehicle(), // Replace with the new screen you want to navigate to
          ),
        );
                    },
