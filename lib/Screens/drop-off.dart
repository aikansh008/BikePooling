...
import 'package:bike_pooling/Screens/passenger_dropoff.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Drop-off", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
            SizedBox(height:20),
            Container(
                   ...
                   Center(
                     child: InkWell(
                      onTap: (){
                       ...
                       context,
                       MaterialPageRoute(
                         builder: (context) => PassengerDropoff(), // Replace with the new screen you want to navigate to
                       ),
                     );
                      },
                       child: Container(
